...
class GenerationPipeline:
    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        if self.settings.trellis.multiview:
            ...
            # logger.info(f"bg_prompt: {background_prompt}")
            # logger.info(f"views_prompt: {views_prompt}")
            ...
            # images_edited[0].save("debug_view0.png")
            # images_edited[1].save("debug_view1.png")
        else:
